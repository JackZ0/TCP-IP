...
#include <netdb.h> 
#define DEST_PORT 80
#define DEST_IP_ADDR "192.168.5.111"
#define DEST_IP_BY_NAME "ddc.zhangh.com"
...
void process_info(int fd)
{
    ...
    while (1)
    {
        printf("begin send\n");
        memset(str1,0,4096);
        strcat(str1,"http://ddc.zhangh.com  HTTP/1.1\r\n");
        strcat(str1,"Accept:application/xml, text/xml, */*; q=0.01\r\n");
        strcat(str1,"Host: ddc.zhangh.com\r\n");
        strcat(str1,"Origin: http://ddc.zhangh.com/Citrix/Storeweb/ \r\n");
